...
//    int[] win_nums = {38, 19, 20, 40, 15, 25};
  ...
  public static int[] solution(int[] lottos, int[] win_nums) {
    ...
    int optimisticHit = 0;
    int pessimisticHit = 0;

    while (lt < lottos.length && wt < win_nums.length){

      if(lottos[lt] == 0){
        optimisticHit++;
        lt++;
      } else if(lottos[lt] == win_nums[wt]){
        lt++;
        wt++;
        optimisticHit++;
        pessimisticHit++;
    ...
    return new int[]{optimisticHit == 0 ? 6 : 7 - optimisticHit, pessimisticHit == 0 ? 6 : 7 - pessimisticHit};
  }
